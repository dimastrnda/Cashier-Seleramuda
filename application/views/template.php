...
<body class="hold-transition skin-black sidebar-mini <?=$this->uri->segment(1) == 'sale' ? 'sidebar-collapse' : null?>">

	<div class="wrapper">
		<header class="main-header">
			<a href="<?=base_url('dashboard')?>" class="logo">
				<span class="logo-mini">S<b>M</b></span>
				<span class="logo-lg"><b>SELERAMUDA</b></span>
			</a>
			...
			<section class="sidebar">
				...
				<ul class="sidebar-menu" data-widget="tree">
					...
					<li class="treeview">
						...
						<ul class="treeview-menu">
							<li><a href="<?=site_url('reports')?>"><i class="fa fa-circle-o"></i> Sales</a></li>
						</ul>
					</li>
